...
texto_moeda_origem = customtkinter.CTkLabel(janela, text="Selicione a Moeda de origem")
texto_moeda_destino = customtkinter.CTkLabel(janela, text="Selicione a Moeda de destino")
...
#Colocar todos os elements na tela
